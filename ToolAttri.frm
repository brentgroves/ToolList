...
Public Sub EnableMultiPart()
    ...
    AllPartNumbersList2.Enabled = True
    AllPartNumbersList2.BackColor = &HFFFFFF
...
Private Sub AddPartBTN_Click()
    ...
    While i < AllPartNumbersList2.ListCount
        If AllPartNumbersList.Selected(i) Then
            While j < SelectedPartsList.ListCount
                If AllPartNumbersList2.List(i) = SelectedPartsList.List(j) Then
                    InList = True
                End If
                j = j + 1
            Wend
            If Not InList Then
                SelectedPartsList.AddItem (AllPartNumbersList2.List(i))
            End If
            j = 0
        End If
        i = i + 1
