...
Private Sub Form_Resize()
    If MDIForm1.WindowState <> vbMinimized Then
        ...
        If ScaleHeight > 1000 Then
            TreeView1.Height = ScaleHeight - 1000
            TreeView2.Height = ScaleHeight - 1000
            TreeView3.Height = ScaleHeight - 1000
            TreeView4.Height = ScaleHeight - 1000
        End If
        ...
        TabStrip1.Left = 0
        If ScaleHeight > 1000 Then
            TabStrip1.Height = ScaleHeight - 1000
        End If
        TabStrip1.Width = ScaleWidth
        If ScaleHeight > 600 Then
            ChgRoutingBtn.Top = ScaleHeight - 600
        End If
        ...
        If ScaleHeight > 600 Then
            ReleaseBtn.Top = ScaleHeight - 600
        End If
