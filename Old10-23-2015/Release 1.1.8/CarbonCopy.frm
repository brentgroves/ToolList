...
Private Sub Copy_Click()
    If Not IsNumeric(NewToolTXT.Text) Then
        MsgBox ("Invalid Tool Number")
        Exit Sub
    End If
    If Not ListView1.SelectedItem Is Nothing And Not ListView2.SelectedItem Is Nothing Then
        CopyTool Val(ListView1.SelectedItem.Text), Val(ListView2.SelectedItem.SubItems(2)), Val(NewToolTXT.Text)
    End If
    ListView1.ListItems.Clear
    ListView2.ListItems.Clear
    NewToolTXT.Text = ""
...
Private Sub LoadTools(pID As Integer)
...
Private Sub CopyTool(pID As Integer, tID As Integer, tNum As Integer)
    Set sqlRS = New adodb.Recordset
