...
Private Sub MDIForm_Load()
    ...
    If Not CheckVersion Then
        MsgBox ("You have an old verion of BuscheToolList.exe.  Copy the updated version from P:\MIS\Busche Software Installation Files\Tool List\ into your c:\program files\buschetoollist directory.")
        Unload Me
    End If
End Sub
